...
bool Sprite::leftBorder(const sf::Vector2i relativePosition, const int borderLeft) const
{
    ...
    LOG_TRACE("sprite/Collision.cpp", fmt::format("'leftBorder()' requested (ID={}) (bool={})", getId(), hitBorder));
    return hitBorder;
}
bool Sprite::rightBorder(const sf::Vector2i relativePosition, const int borderRight) const
{
    ...
    LOG_TRACE("sprite/Collision.cpp", fmt::format("'rightBorder()' requested (ID={}) (bool={})", getId(), hitBorder));
    return hitBorder;
}
bool Sprite::topBorder(const sf::Vector2i relativePosition, const int borderTop) const
{
    ...
    LOG_TRACE("sprite/Collision.cpp", fmt::format("'topBorder()' requested (ID={}) (bool={})", getId(), hitBorder));
    return hitBorder;
}
bool Sprite::bottomBorder(const sf::Vector2i relativePosition, const int borderBottom) const
{
    ...
    LOG_TRACE("sprite/Collision.cpp", fmt::format("'bottomBorder()' requested (ID={}) (bool={})", getId(), hitBorder));
    return hitBorder;
}
...
{
    LOG_TRACE("sprite/Collision.cpp", fmt::format("'collisionBox()' requested (ID={}) checking for collision...", getId()));
    ...
    LOG_TRACE("sprite/Collision.cpp", fmt::format("Collision detected with {}", objectID));
    return objectID;
}