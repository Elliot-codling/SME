...
sf::Vector2f Sprite::getPosition() const
{
    ...
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'getPosition()' requested (ID={}) (pos={},{})", getId(), position.x, position.y));
    return position;
}
sf::Vector2f Sprite::getGlobalPosition() const
{
    ...
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'getGlobalPosition()' requested (ID={}) (pos={},{})", getId(), position.x, position.y));
    return position;
}
void Sprite::setPosition(const sf::Vector2f position)
{
    const sf::Vector2f newPosition = {position.x + getOffset().x, position.y + getOffset().y};
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'setPosition()' requested (ID={}) (pos_requested={},{}) (pos_returned={},{})", getId(), position.x, position.y, newPosition.x, newPosition.y));
...
void Sprite::incrementPosition(const sf::Vector2f position)
{
    ...
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'incrementPosition()' requested (ID={}) (pos_requested={},{}) (pos_returned={},{})", getId(), position.x, position.y, newPosition.x, newPosition.y));
    m_sprite.setPosition(newPosition);
}
...
{
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'setOffset()' requested (ID={}) (offset={},{})", getId(), objectOffset.x, objectOffset.y));
...
void Sprite::setOrigin(const sf::Vector2f origin)
{
    ...
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'setOrigin()' requested (ID={}) (origin_requested={},{}) (origin_returned={},{})", getId(), origin.x, origin.y, newOrigin.x, newOrigin.y));
...
float Sprite::getAngle() const
{
    ...
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'getAngle()' requested (ID={}) (angle={})", getId(), angle));
    return angle;
}
void Sprite::setAngle(const float angle)
{
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'setAngle()' requested (ID={}) (angle={})", getId(), angle));
    m_sprite.setRotation(angle);
}
void Sprite::incrementAngle(const float angle)
{
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'incrementAngle()' requested (ID={}) (angle={})", getId(), angle));
...
sf::Vector2f Sprite::getSize() const
{
    ...
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'getSize()' requested (ID={}) (size={},{})", getId(), size.x, size.y));
    return size;
}
sf::Vector2f Sprite::getGlobalSize() const
{
    ...
    LOG_TRACE("sprite/Transforms.cpp", fmt::format("'getGlobalSize()' requested (ID={}) (size={},{})", getId(), size.x, size.y));
    return size;
}
void Sprite::setSize(const sf::Vector2f size)
{
    if (!m_texture->isRepeated())
    {
        ...
        LOG_TRACE("sprite/Transforms.cpp", fmt::format("'setSize()' requested (ID={}) (size={},{}) (scale={},{}) (texture_repeated=false)", getId(), size.x, size.y, scale.x, scale.y));
        m_sprite.setScale(scale);
    }
    else
    {
        LOG_TRACE("sprite/Transforms.cpp", fmt::format("'setSize()' requested (ID={}) (size={},{}) (texture_repeated=true)", getId(), size.x, size.y));
